...
Public Class BuiltinFunctions
    ...
    Public Shared ReadOnly BIF_subst As FunctionSymbol = New FunctionSymbol("%subst", ImmutableArray.Create(New ParamiterSymbol("A", TypeSymbol.Char_), New ParamiterSymbol("B", TypeSymbol.Integer_), New ParamiterSymbol("C", TypeSymbol.Integer_)), TypeSymbol.Char_)
    ...
    Public Shared ReadOnly BIF_Lower As FunctionSymbol = New FunctionSymbol("char", ImmutableArray.Create(New ParamiterSymbol("A", TypeSymbol.Char_)), TypeSymbol.Char_)
    Public Shared ReadOnly BIF_Upper As FunctionSymbol = New FunctionSymbol("char", ImmutableArray.Create(New ParamiterSymbol("A", TypeSymbol.Char_)), TypeSymbol.Char_)
    ...
    Public Shared ReadOnly BIF_date As FunctionSymbol = New FunctionSymbol("date", ImmutableArray.Create(New ParamiterSymbol("A", TypeSymbol.Char_)), TypeSymbol.Date_)
    Public Shared ReadOnly BIF_dec As FunctionSymbol = New FunctionSymbol("%dec", ImmutableArray.Create(New ParamiterSymbol("A", TypeSymbol.Char_)), TypeSymbol.Integer_)
    Public Shared ReadOnly BIF_int As FunctionSymbol = New FunctionSymbol("%int", ImmutableArray.Create(New ParamiterSymbol("A", TypeSymbol.Char_)), TypeSymbol.Integer_)
    Public Shared ReadOnly BIF_Rand As FunctionSymbol = New FunctionSymbol("%rand", ImmutableArray.Create(New ParamiterSymbol("A", TypeSymbol.Integer_)), TypeSymbol.Integer_)
    Public Shared ReadOnly BIF_Len As FunctionSymbol = New FunctionSymbol("%len", ImmutableArray.Create(New ParamiterSymbol("A", TypeSymbol.Char_)), TypeSymbol.Integer_)
    Public Shared ReadOnly BIF_Log As FunctionSymbol = New FunctionSymbol("%log", ImmutableArray.Create(New ParamiterSymbol("A", TypeSymbol.Integer_)), TypeSymbol.Integer_)
    Public Shared ReadOnly BIF_Log10 As FunctionSymbol = New FunctionSymbol("%log10", ImmutableArray.Create(New ParamiterSymbol("A", TypeSymbol.Integer_)), TypeSymbol.Integer_)
    Public Shared ReadOnly BIF_Sqrt As FunctionSymbol = New FunctionSymbol("%sqrt", ImmutableArray.Create(New ParamiterSymbol("A", TypeSymbol.Integer_)), TypeSymbol.Integer_)
    ...
    Public Shared ReadOnly BIF_trim As FunctionSymbol = New FunctionSymbol("trim", ImmutableArray.Create(New ParamiterSymbol("A", TypeSymbol.Char_)), TypeSymbol.Char_)
